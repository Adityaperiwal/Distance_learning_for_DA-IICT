          ...
          <v-card>
            ...
            >
              <template slot="items" slot-scope="props">
                ...
                <v-btn flat class="green white--text" v-bind:to="{name: 'viewevaluationstudents', params: {id: item._id }}">View
                </v-btn>
              </template>
  ...
  export default {
    ...
    methods: {
      async getDetail () {
        ...
        console.log('view id called')
        if (jwt) {
          Axios.get('http://192.168.137.1:3000/faculty/evaluation/subtopics/view/' + this.$route.params.id,
            {
              headers: {
